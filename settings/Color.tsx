...
const Color = ({
  ...
  <div className="flex flex-col gap-3 border-b border-primary-grey-200 p-5">
    ...
    <div
      className="ml-4 flex items-center gap-2 border border-primary-grey-200"
    ...
    >
      ...
      <Label className="flex h-6 w-8 items-center justify-center bg-primary-grey-100 text-[10px] leading-3"></Label>
    </div>
  </div>
);
